...
class Visualizer:
    ...
    def plot_patch_mask(self, image, patch_mask, patch_size, figsize=(10, 5)):
        """
    ...
    def visualize_prediction(self, image, prediction_result, mask=None, patch_mask=None, 
                           patch_size=None, figsize=(14, 6)):
        """
        ...
        Args:
            ...
            patch_size (int, optional): Size of each patch (required if patch_mask provided)
            figsize (tuple): Figure size
